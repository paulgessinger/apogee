...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['base_user_id'], ['user.id'], name=op.f('fk_pull_request_base_user_id_user')),
    sa.ForeignKeyConstraint(['head_user_id'], ['user.id'], name=op.f('fk_pull_request_head_user_id_user')),
